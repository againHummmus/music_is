...
export default function Search({
  ...
  return (
    <div className={`relative z-50`}>
      <div className="group flex h-[40px] cursor-pointer items-center overflow-hidden rounded-full border border-mainOrange transition-all duration-300 after:absolute after:left-0 after:top-0 after:-z-[1] after:h-full after:w-full after:bg-white/20 after:backdrop-blur main:max-laptop:absolute main:max-laptop:right-0 laptop:w-[250px]">
        ...
        >
          <HugeiconsCancel01 className="h-[40px] w-[40px] p-[8px] text-white transition-all duration-300" />
        </button>
      </div>
    </div>
  );
